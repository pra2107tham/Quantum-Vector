...
const webinarData: Record<string, any> = {
  "devsecops-eks-may-2026": {
    ...
    techStack: [
      { layer: "CI/CD Engine", tech: "Jenkins Declarative Pipeline", accent: "#1447e6" },
      { layer: "AI Security", tech: "AI Secret Detection, AI Code Review, AI Vulnerability Analysis, AI CVE Prioritization, AI Container Risk Scoring, AI Policy Recommendation, AI Manifest Security Review, AI Runtime Threat Detection", accent: "#e54a2d" },
      { layer: "Build & Test", tech: "Maven, JaCoCo, JUnit", accent: "#1447e6" },
      { layer: "SAST", tech: "SonarQube, Quality Gate", accent: "#0ea5e9" },
      { layer: "SCA", tech: "OWASP Dependency Check", accent: "#0ea5e9" },
      { layer: "Container Security", tech: "Trivy Image Scanner", accent: "#6366f1" },
      { layer: "Policy-as-Code", tech: "OPA, Conftest", accent: "#6366f1" },
      { layer: "Containerization", tech: "Docker, Docker Hub", accent: "#1447e6" },
      { layer: "Orchestration", tech: "AWS EKS, Kubernetes", accent: "#ff9900" },
      { layer: "Access Control", tech: "IAM, RBAC, securityContext", accent: "#ff9900" },
      { layer: "Database", tech: "RDS PostgreSQL", accent: "#198754" },
      { layer: "Source Control", tech: "GitHub", accent: "#2d2d2d" },
    ],
    whyMatters: {
    ...
    projectHighlight: {
      ...
      services: [
        "Jenkins Pipeline: Declarative CI/CD engine orchestrating all stages",
        "AI Secret Detection: Scans commits for exposed keys and credentials",
        "AI Code Review: Flags logic errors and anti-patterns before build",
        "Maven + JaCoCo: Build, test, and enforce code coverage thresholds",
        "SonarQube SAST: Static code analysis — catches vulnerabilities early",
        "AI Vulnerability Analysis: Contextual risk scoring of SonarQube findings",
        "Quality Gate: Hard pass/fail enforcement before proceeding",
        "OWASP Dependency Check: SCA — scans open-source libraries for CVEs",
        "AI CVE Prioritization: Ranks CVEs by exploitability and business impact",
        "Trivy Image Scanner: Scans Docker base images for OS-level CVEs",
        "AI Container Risk Scoring: Recommends safer base images automatically",
        "OPA + Conftest: Policy-as-code enforcement on Dockerfile and K8s",
        "AI Policy Recommendation: Auto-suggests missing security rules",
        "Docker + Docker Hub: Containerizes and pushes the verified image",
        "AI Manifest Security Review: Validates RBAC, resource limits, securityContext",
        "AWS EKS Deployment: Live Kubernetes deployment — Snake Game + Calculator",
        "AI Runtime Threat Detection: Post-deploy monitoring for anomalies and threats",
        "RDS (PostgreSQL): Production-grade managed database backend",
      ],
    },
    projects: [
      "Module 1 — Day 1: Set up Jenkins pipeline, GitHub integration, and AI Secret Detection on developer commits",
      "Module 2 — Day 1: Maven compile, AI Test Case Generation, JUnit testing, and JaCoCo coverage enforcement",
      "Module 3 — Day 1: SonarQube SAST scan, AI Vulnerability Analysis, and Quality Gate enforcement",
      "Module 4 — Day 1: OWASP Dependency Check (SCA), AI CVE Prioritization, and Trivy base image scan",
      "Module 5 — Day 2: AI Container Risk Scoring, OPA Dockerfile policy validation, AI Policy Recommendations",
      "Module 6 — Day 2: Docker image build and push to Docker Hub, OPA Kubernetes manifest validation",
      "Module 7 — Day 2: AI Manifest Security Review — RBAC, resource limits, securityContext checks",
      "Module 8 — Day 2: AWS EKS deployment of Snake Game + Calculator, AI Runtime Threat Detection setup",
    ],
    outcomes: [
    ...
    whereToLearn: {
      title: "Keep Building After the Project 🏗️",
      content:
        "After completing this DevSecOps project, explore advanced topics like multi-cluster security policies, GitOps with ArgoCD and policy enforcement, advanced OPA Rego policies, and AI-driven incident response. The shift-left security skills you learn here apply directly to enterprise CI/CD pipelines, compliance-driven environments, and platform engineering roles. Contact us at frontdesk@thedevopscommunity.com for any questions.",
    },
    paymentLink: "https://rzp.io/rzp/7XyLY9Wf",
  },
  ...
  "terraform-webinar-2026": {
    ...
    whyMatters: {
      ...
      content:
        "Modern infrastructure demands automation, repeatability, and version control. Terraform has become the industry standard for Infrastructure as Code, enabling teams to provision and manage cloud resources safely and efficiently. This webinar teaches production-grade Terraform workflows, state management, and collaboration patterns used by companies managing infrastructure at scale.",
    },
    projects: [
      "Provision a Multi-Tier Application with Networking and Security Groups",
      "Deploy and Manage Kubernetes Cluster with Terraform",
      "Automate Cloud Networking (VPCs, Subnets, Gateways)",
      "Implement Auto-Scaling Infrastructure",
      "Multi-Cloud Resource Provisioning",
      "Create Custom Modules for Reuse and Standardization",
      "Automate Resource Cleanup and Versioned Deployments",
    ],
    outcomes: [
      "Master Terraform fundamentals and Infrastructure as Code concepts",
      "Implement remote state management with locking and versioning",
      "Build reusable, production-ready Terraform modules",
      "Manage multi-environment infrastructure safely",
      "Integrate Terraform into CI/CD pipelines",
      "Handle secrets and sensitive data securely",
      "Understand resource dependencies and advanced patterns",
    ],
    whatYoullLearn: [
      ...
      "State Management: Local and Remote State, locking and versioning",
      "Variables and Outputs: Input variables, output variables, sensitive data",
      "Terraform Functions and Expressions",
      "Resource Dependencies and Graph",
      "Loops and Conditionals: count, for_each, conditional expressions",
      "Creating reusable modules and using Registry modules",
      "Data Sources and Provisioners (local-exec, remote-exec)",
      "Lifecycle Rules: create_before_destroy, prevent_destroy",
      "Workspaces for Environment Segregation",
      "Remote Backend Options: AWS S3 + DynamoDB, Azure Storage, GCP",
      "Terraform Cloud and Enterprise Features",
      "State Management in Teams and handling conflicts",
      "Dynamic Blocks for Flexible Configurations",
      "Handling Secrets with Vault and environment variables",
      "Testing Terraform Code and debugging techniques",
      "Best Practices for Production Terraform",
    ],
    whoIsFor: [
      "DevOps engineers with 4-5 years of experience",
      "Cloud engineers managing infrastructure automation",
      "SRE professionals implementing Infrastructure as Code",
      "Platform engineers building self-service infrastructure",
      "Backend developers moving toward DevOps/Platform roles",
      "Anyone with cloud experience wanting to master Terraform",
    ],
    whatYoullGet: [
      "7+ hours of live, hands-on sessions across 5 days",
      "Real-world project walkthroughs with production patterns",
      "Reusable Terraform modules and templates",
      "CI/CD integration examples and automation scripts",
      "Best practices documentation and code organization guides",
  ...
  "mcp-eks-webinar-2026": {
    id: "mcp-eks-webinar-2026",
    title: "MCP + AI Platform on Kubernetes (EKS)",
    tagline:
      "Build a Production-Grade AI Control Plane on Kubernetes — Not Just Tutorials. Real Systems. Real Companies.",
    ...
    originalPrice: null,
    mode: "Live Online",
    bonus: "Full source code + Kubernetes manifests + Terraform configs + CI/CD pipelines + Grafana dashboards + recordings",
    status: "upcoming",
    description:
    ...
    projects: [
      ...
      "Day 1: Build the Model Control Plane — registration, versioning, and lifecycle management",
    ...
    outcomes: [
      ...
      "Design the control plane layer — a very rare and highly valued engineering skill",
    ],
    whatYoullLearn: [
    ...
    whatYoullGet: [
      "2 days of live, hands-on sessions — 3 hours each (7–10 PM IST)",
      "Full source code — complete MCP platform on EKS, yours to keep",
  ...
  "aws-eks-workshop-2026": {
    ...
    whatYoullGet: [
      "2 live sessions (2 hours each) on 14th & 15th March 2026",
